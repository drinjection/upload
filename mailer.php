...
{ 
    ...
    $testa =""; 
    $message = "<html><body><h1>Put your text here</h1></body></html>"; 
...
<html> 
<head> 
<title> Mailer Private</title></head> 
</head> 
...
<td>Name:   <input name="RealName" type="text" class="form" id="RealName" size="30" value="<? print $nombre; ?>"></td> 
</tr> 
</table> 
</td> 
</tr> 
<tr> 
<td>Title: <input name="assunto" type="text" class="form" id="assunto" size="78" value="<? print $subject; ?>"></td> 
</tr> 
<tr> 
...
echo "<script> alert('---Tools Spammed OK---'); </script>"; 
?> 
</td> 
</tr> 
</table> 
