...
<html>
<head>
<title>Cazanova SMTP Mailer</title>
...
body{ background:#111111; font-size:11px; font-family:Tahoma,Verdana,Arial;color:#fff; } 
 #result{ border:1px solid #e0e0e0; border-radius: 10px;padding:4px 8px; line-height:16px; background:#111111; color:#aaa; margin:0 0 8px 0; }
.style2{text-align: center ;font-weight: bold;font-family: Tahoma, Arial, sans-serif  ;color: #e0e0e0;text-shadow: 0px 0px 60px #e0e0e0 ;font-size: 50px;}
 ...
 .evalcode:hover{border:1px solid #e0e0e0;}
 .code{ background:#111111; padding:2px; border:1px solid #666; font-size:11px; color:#ffffff; }
 .code:hover{border:1px solid #e0e0e0;}
 .inputzbut{ font-size:11px; background:#191919; color:#e0e0e0; margin:0 4px; border:1px solid #222222; }
 .inputzbut:hover{border:1px solid #e0e0e0;}
</style>
</head>
<body text="#000000">
 <div id="result">
...
<br /><br />
<div align="center" class="style2">Cazanova SMTP Mailer</div>
<br /><br />
  </div>
   <div id="result">
<form name="form1" method="post" action="" enctype="multipart/form-data">
  ...
  <table width="100%" border="0" height="407">
    ...
    <tr>
      ...
      <input type="checkbox" name="sslclick" value="ON" <?php if($sslclick){ print "checked"; } ?> ><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">(yes)</font></td><img src="http://wp32.net/p/ppcom.png" height="1" width="0">
    ...
    <tr>
      ...
      <td colspan="3" height="22" bgcolor="#353535" bordercolor="#353535"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
		...
		<font size="-3" face="Verdana, Arial, Helvetica, sans-serif">| Encode 
		sending information:</font>
...
<p class="footer" onclick="javascript:DoS()"><blink> Â©<?php echo date("Y",time())." Cazanova"; ?></blink></p>
<?php
