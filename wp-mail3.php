 ...
 *----------------------------------------------------------*
 *	Name : mailer-*
 *	Coder: GwEx Net on youtube chanel --------------------*
 *	Email: imgwex@gmail.com------*
 *	Date : january 2013--------------------------------*
 * ---------------------------------------------------------*/
-->
</style>
...
<br><br><br><br>a
<div class="myform">
<center><font color=black size=10>GwEx Mailer </font>
<br><br>
...
<br><br>
<input type="submit" name="post" class="button" value="SEND">
</form>
</div>
<?php 
if (isset($_POST['post']))
