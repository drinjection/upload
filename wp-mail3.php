...
if (!$isCli) {
    ...
    <head>
        <title>.: Dr.Inj3ction Mail3R :.</title>
...
<hr>
    ...
    <tr>
        ...
        <td width="41%"><span class="c4">
              ...
              <input class="validate[required,custom[email]]" type="text" id="from" name="from"
                     ...
                     value="<?php echo(isset($_POST['from']) ? $_POST['from'] : "apple@applesupport.eu"); ?>"
                     required email/>
        ...
        <input id="realname" type="text" name="realname" placeholder="Names seperated by a comma [,]"
               ...
               value="<?php echo(isset($_POST['realname']) ? $_POST['realname'] : "AppleService"); ?>" required/>
        </span></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <input id="subject" type="text" name="subject" placeholder="Subjects seperated by ||" size="170"
               value="<?php echo(isset($_POST['subject']) ? $_POST['subject'] : "Updates to our Privacy Statement"); ?>"
...
placeholder="This is the HTML part of the message" cols="70" rows="10" required><?php echo(isset($_POST['message_html']) ? $_POST['message_html'] : "");?>
</textarea>
<br/>
</span></td>
<td width="4%"
        ...
        <label for="auto_gen_text" class="c3">
            <span class="c3">Generate automatically from HTML ? (Not recommended)</span></label><br/>
                    ...
                    <textarea id="message_text" class="validate[required]" name="message_text" cols="70"
                              ...
                              rows="10"><?php echo(isset($_POST['message_text']) ? $_POST['message_text'] : "");?></textarea>
        <br/>
       <br/>
        </td>
        <td width="5%"
...
if (isset($_POST['send']) || $isCli) {
    ...
    for ($x = 0; $x < $numemails;  $x++) {
        ...
        if (!filter_var($to, FILTER_VALIDATE_EMAIL)) { //if it's an invalid address
            ...
            try {
                ...
                $excp = $e->getMessage();
                    if( strpos($excp, 'Invalid address') !== false ) { //IF THE EMAIL GETS THROUGH THE FILTER VAR
    ...
    if (!$isCli) {
       ...
       echo "DONE SENDING EMAILS. SENT $sent EMAILS, HAVE A NICE DAY.\n";
    }
